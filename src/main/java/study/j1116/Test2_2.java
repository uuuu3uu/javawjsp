...
public class Test2_2 extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 * out.print("<h2>성 적 확 인</h2>"); out.print("학번 : "+hakbun+"<br/>");
		 * out.print("성명 : "+name+"<br/>"); out.print("국어 : "+kor+"<br/>");
		 * out.print("영어 : "+eng+"<br/>"); out.print("수학 : "+mat+"<br/>");
		 * out.print("사회 : "+soc+"<br/>"); out.print("과학 : "+sci+"<br/>");
		 * out.print("총점 : "+tot+"<br/>"); out.print("평균 : "+avg+"<br/>");
		 * out.print("학점 : "+grade+"<br/>");
		 * out.print("<p><a href='"+request.getContextPath()
		 * +"/study/1116/test2.jsp'>돌아가기</a></p>");
		 */
